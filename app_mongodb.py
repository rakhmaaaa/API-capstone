...
def register():
    ...
    try:
        ...
        url = f"https://25f0-103-158-253-155.ngrok-free.app/verify-account/{email_token}"
...
def update_profile():
    try:
        ...
        args = updateProfileParser.parse_args()
...
def forgot_password():
    ...
    try:
        ...
        url = f"https://25f0-103-158-253-155.ngrok-free.app/user/reset-password/{password_reset_token}"
